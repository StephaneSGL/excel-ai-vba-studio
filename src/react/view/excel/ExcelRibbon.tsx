...
function RibbonButton({
    ...
    const tooltip = title
        ?? (unavailable ? `${label} — not yet available in the embedded editor` : label);
    ...
    const renderFileTab = () => (
        <>
            ...
            <RibbonGroup label="Open">
                <RibbonButton large icon={<FileExcelOutlined />} label="Open in Excel" onClick={onOpenNativeExcel} />
                <RibbonButton large icon={<CodeOutlined />} label="VBA Editor" onClick={onOpenVbaDeveloper} />
                {showEditInVscode && (
            ...
            <RibbonGroup label="Create">
                <RibbonButton large icon={<FileAddOutlined />} label="New Workbook" unavailable />
                <RibbonButton large icon={<SettingOutlined />} label="Options" unavailable />
            </RibbonGroup>
        </>
    );
    ...
    const renderHomeTab = () => (
        <>
            ...
            <RibbonGroup label="Styles">
                ...
                <RibbonButton icon={<TableOutlined />} label="Format as Table" unavailable />
                <RibbonButton icon={<BarChartOutlined />} label="Conditional Formatting" unavailable />
            </RibbonGroup>
    ...
    const renderInsertTab = () => (
        <>
            <RibbonGroup label="Tables">
                <RibbonButton large icon={<TableOutlined />} label="PivotTable" unavailable />
                <RibbonButton large icon={<TableOutlined />} label="Table" unavailable />
            </RibbonGroup>
            <RibbonGroup label="Cells">
            ...
            <RibbonGroup label="Illustrations">
                <RibbonButton large icon={<PictureOutlined />} label="Pictures" unavailable />
                <RibbonButton large icon={<LayoutOutlined />} label="Shapes" unavailable />
                <RibbonButton large icon={<ApartmentOutlined />} label="SmartArt" unavailable />
            </RibbonGroup>
            <RibbonGroup label="Charts">
                <RibbonButton large icon={<BarChartOutlined />} label="Recommended Charts" unavailable />
                <RibbonButton large icon={<BarChartOutlined />} label="Column Chart" unavailable />
                <RibbonButton large icon={<BarChartOutlined />} label="Line Chart" unavailable />
            </RibbonGroup>
    ...
    const renderLayoutTab = () => (
        <>
            <RibbonGroup label="Themes">
                <RibbonButton large icon={<LayoutOutlined />} label="Themes" unavailable />
                <RibbonStack>
                    <RibbonButton compact icon={<BgColorsOutlined />} label="Colors" unavailable />
                    <RibbonButton compact icon={<FontColorsOutlined />} label="Fonts" unavailable />
                    <RibbonButton compact icon={<SettingOutlined />} label="Effects" unavailable />
                </RibbonStack>
            </RibbonGroup>
            <RibbonGroup label="Page Setup">
                <RibbonButton large icon={<LayoutOutlined />} label="Margins" unavailable />
                <RibbonButton large icon={<LayoutOutlined />} label="Orientation" unavailable />
                <RibbonButton large icon={<FileTextOutlined />} label="Size" unavailable />
                <RibbonButton large icon={<PrinterOutlined />} label="Print Area" onClick={() => command('print')} disabled={!ready} />
                <RibbonButton large icon={<PictureOutlined />} label="Background" unavailable />
            </RibbonGroup>
            <RibbonGroup label="Sheet Options">
                ...
                <RibbonButton large icon={<ColumnHeightOutlined />} label="Headings" unavailable />
            </RibbonGroup>
            <RibbonGroup label="Scale to Fit">
                <RibbonButton large icon={<ColumnHeightOutlined />} label="Width: Auto" unavailable />
                <RibbonButton large icon={<ColumnHeightOutlined />} label="Height: Auto" unavailable />
            </RibbonGroup>
            <RibbonGroup label="Arrange">
                <RibbonButton large icon={<LayoutOutlined />} label="Bring Forward" unavailable />
                <RibbonButton large icon={<LayoutOutlined />} label="Send Backward" unavailable />
                <RibbonButton large icon={<LayoutOutlined />} label="Selection Pane" unavailable />
            </RibbonGroup>
        </>
    );
    ...
    const renderFormulasTab = () => (
        <>
            ...
            <RibbonGroup label="Defined Names">
                <RibbonButton large icon={<FileTextOutlined />} label="Name Manager" unavailable />
                <RibbonButton large icon={<FileAddOutlined />} label="Define Name" unavailable />
            </RibbonGroup>
            <RibbonGroup label="Formula Auditing">
                <RibbonButton large icon={<ApartmentOutlined />} label="Trace Precedents" unavailable />
                <RibbonButton large icon={<ApartmentOutlined />} label="Trace Dependents" unavailable />
                <RibbonButton large icon={<EyeOutlined />} label="Show Formulas" unavailable />
                <RibbonButton large icon={<SearchOutlined />} label="Error Checking" unavailable />
            </RibbonGroup>
            <RibbonGroup label="Calculation">
                <RibbonButton large icon={<CalculatorOutlined />} label="Calculate Now" unavailable />
                <RibbonButton large icon={<SettingOutlined />} label="Calculation Options" unavailable />
            </RibbonGroup>
        </>
    );
    ...
    const renderDataTab = () => (
        <>
            <RibbonGroup label="Get & Transform Data">
                <RibbonButton large icon={<FileTextOutlined />} label="Get Data" unavailable />
                <RibbonButton large icon={<FileTextOutlined />} label="From Text/CSV" unavailable />
                <RibbonButton large icon={<FileTextOutlined />} label="From Web" unavailable />
                <RibbonButton large icon={<TableOutlined />} label="From Table/Range" unavailable />
            </RibbonGroup>
            <RibbonGroup label="Sort & Filter">
                <RibbonButton large icon={<SortAscendingOutlined />} label="Sort" unavailable />
            ...
            <RibbonGroup label="Data Tools">
                <RibbonButton large icon={<ColumnHeightOutlined />} label="Text to Columns" unavailable />
                <RibbonButton large icon={<DeleteOutlined />} label="Remove Duplicates" unavailable />
            ...
            <RibbonGroup label="Outline">
                <RibbonButton large icon={<LayoutOutlined />} label="Group" unavailable />
                <RibbonButton large icon={<LayoutOutlined />} label="Ungroup" unavailable />
                <RibbonButton large icon={<CalculatorOutlined />} label="Subtotal" unavailable />
            </RibbonGroup>
            <RibbonGroup label="Analyze">
                <RibbonButton large icon={<RobotOutlined />} label="What-If Analysis" unavailable />
                <RibbonButton large icon={<BarChartOutlined />} label="Forecast Sheet" unavailable />
            </RibbonGroup>
        </>
    );
    ...
    const renderReviewTab = () => (
        <>
            <RibbonGroup label="Proofing">
                <RibbonButton large icon={<SearchOutlined />} label="Spelling" unavailable />
                <RibbonButton large icon={<FileTextOutlined />} label="Thesaurus" unavailable />
                <RibbonButton large icon={<NumberOutlined />} label="Workbook Statistics" unavailable />
            </RibbonGroup>
            <RibbonGroup label="Language">
                <RibbonButton large icon={<RobotOutlined />} label="Translate" unavailable />
            </RibbonGroup>
            <RibbonGroup label="Comments">
                <RibbonButton large icon={<CommentOutlined />} label="New Comment" unavailable />
                <RibbonButton large icon={<CommentOutlined />} label="Show Comments" unavailable />
            </RibbonGroup>
            <RibbonGroup label="Protect">
                ...
                <RibbonButton large icon={<LockOutlined />} label="Protect Sheet" unavailable />
                <RibbonButton large icon={<LockOutlined />} label="Protect Workbook" unavailable />
            </RibbonGroup>
        </>
    );
    ...
    const renderViewTab = () => (
        <>
            <RibbonGroup label="Workbook Views">
                <RibbonButton large icon={<TableOutlined />} label="Normal" disabled={!ready} />
                <RibbonButton large icon={<LayoutOutlined />} label="Page Break Preview" unavailable />
                <RibbonButton large icon={<FileTextOutlined />} label="Page Layout" unavailable />
            </RibbonGroup>
            <RibbonGroup label="Show">
                <RibbonButton large icon={<EyeOutlined />} label={gridVisible ? 'Gridlines On' : 'Gridlines Off'} onClick={toggleGrid} disabled={!ready} />
                <RibbonButton large icon={<ColumnHeightOutlined />} label="Headings" unavailable />
                <RibbonButton large icon={<FunctionOutlined />} label="Formula Bar" unavailable />
            </RibbonGroup>
            <RibbonGroup label="Zoom">
                <RibbonButton large icon={<SearchOutlined />} label="Zoom" unavailable />
                <RibbonButton large icon={<NumberOutlined />} label="100%" unavailable />
                <RibbonButton large icon={<SearchOutlined />} label="Zoom to Selection" unavailable />
            </RibbonGroup>
            <RibbonGroup label="Window">
                <RibbonButton large icon={<WindowsOutlined />} label="New Window" onClick={onOpenNativeExcel} />
                <RibbonButton large icon={<LayoutOutlined />} label="Freeze Panes" onClick={() => toggle('freeze')} disabled={editingDisabled} />
                <RibbonButton large icon={<LayoutOutlined />} label="Split" unavailable />
            </RibbonGroup>
    ...
    const renderAiVbaTab = () => (
        <>
            <RibbonGroup label="AI Context">
                ...
                <RibbonButton large icon={<CopyOutlined />} label="Prepare for AI" onClick={onExportWorkbookContext} />
            </RibbonGroup>
            <RibbonGroup label="VBA">
                <RibbonButton large icon={<CodeOutlined />} label="Open VBA Editor" onClick={onOpenVbaDeveloper} />
                <RibbonButton large icon={<FileTextOutlined />} label="Export VBA Sources" onClick={onOpenVbaExplorer} />
            </RibbonGroup>
            <RibbonGroup label="Excel Desktop">
                <RibbonButton large icon={<FileExcelOutlined />} label="Open Full Excel" onClick={onOpenNativeExcel} />
            </RibbonGroup>
