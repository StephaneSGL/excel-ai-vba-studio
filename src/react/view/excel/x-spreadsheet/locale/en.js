export default {
  ...
  viewer: {
    ...
    macroReadonlyBanner: 'VBA protection — .xlsm and .xls are view-only here so macros and legacy workbook records are not lost.',
    ...
    openNativeExcel: 'Open in Excel',
    openVbaDeveloper: 'Open VBA / VBE',
